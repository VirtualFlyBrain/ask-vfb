...
| Subunit | C2 (5 ds) | L1 (5 ds) | L2 (5 ds) | L5 (4 ds, no Davie) |
|---|---|---|---|---|
| [Rdl](https://v2.virtualflybrain.org/org.geppetto.frontend/geppetto?id=FBgn0004244) (Cl⁻) | **5/5, extent 0.83–0.96** (1713–6073) | 5/5 but **low extent 0.27–0.59** (352–2841) | 4/5, low extent 0.27–0.48 (313–2545) | **4/4, extent 0.88–0.97** (1608–4407) |
| [Grd](https://v2.virtualflybrain.org/org.geppetto.frontend/geppetto?id=FBgn0001134) (cation candidate) | **0/5 — absent** | 4/5, extent 0.23–0.46 (335–1278) | **5/5, extent 0.28–0.66** (342–1314) | **0/4 — absent** |
| [Lcch3](https://v2.virtualflybrain.org/org.geppetto.frontend/geppetto?id=FBgn0010240) (β-subunit) | 4/5, extent 0.33–0.64 (316–1396) | 4/5, extent up to 0.80 (308–1308) | 3/5, extent up to 0.80 (312–484) | 2/4, extent up to 0.66 |
| [CG8916](https://v2.virtualflybrain.org/org.geppetto.frontend/geppetto?id=FBgn0030707) (cation candidate) | **0/5 — absent** | 3/5, extent up to 0.54 (295–739) | 3/5, extent up to 0.70 (327–674) | **0/4 — absent** |
...
[**E**] **L5 has a markedly different GABA-A profile from L1/L2** — Rdl is robust (extent 0.88–0.97, comparable to C2) while Grd and CG8916 are entirely absent. L5 looks like C2 in this respect, *not* like L1/L2.

[**H**] **Sign-asymmetric loop hypothesis (refined):** the L1/L2 ↔ C2 loop has the *potential* to be sign-asymmetric. The L1 → C2 limb is biophysically expected to be inhibitory/shunting (GluClα). The C2 → L1/L2 return limb could be **mixed**: classical Cl⁻ inhibition through Rdl-containing receptors in some L1/L2 cells, and depolarisation through Grd/Lcch3-containing channels in others. The C2 → L5 return limb, by contrast, is *predicted to be classically inhibitory* given L5's Rdl-rich, Grd-/CG8916-negative profile. This molecular heterogeneity across C2's L-cell targets is *consistent with* — but does not on its own demonstrate — the asymmetric-filtering function proposed by Tuthill et al. (2013). Direct electrophysiology of the C2 → L1/L2/L5 synapses in Drosophila would be needed to settle whether Grd/Lcch3 channels operate as cation channels in vivo and how the two GABA-A populations are partitioned across L cells.

---

## 7. Circuit summary diagram
